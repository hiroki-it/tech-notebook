...
| 送信元プライベートIPアドレス | SNATによる変換 | 送信元グローバルIPアドレス |
| :--------------------------: | :------------: | :------------------------: |
...
: 『送信元プライベートIPアドレス』『宛先グローバルIPアドレス』『DNSサーバーでTCPハンドシェイクを受信する`53`番ポート』を指定して、DNSサーバーにリクエストを送信する。
...
| 送信元プライベートIPアドレス | 変換前ポート番号 | DNATによる変換 | 送信元グローバルIPアドレス | 変換後ポート番号 |
| :--------------------------: | :--------------: | :------------: | :------------------------: | :--------------: |
