---
title: 【IT技術の知見】資格情報の運搬＠資格情報による分類
description: 資格情報の運搬＠資格情報による分類の知見を記録しています。
---
...
: サーバーは、DBの資格情報を照合し、ログインを許可する。サーバーは、セッションIDを作成し、セッションデータに書き込む。
