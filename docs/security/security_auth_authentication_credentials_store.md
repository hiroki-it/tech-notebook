---
title: 【IT技術の知見】資格情報の保管＠資格情報による分類
description: 資格情報の保管＠資格情報による分類の知見を記録しています。
---
...
セッションIDで資格情報を運搬した場合、初回認証以降に、認証の成功状態を維持する必要がある。
...
トークン (例：アクセストークン、IDトークンなど) で資格情報を運搬した場合、初回認証以降に、認証の成功状態を維持する必要がある。
