---
title: 【IT技術の知見】ペイロードの暗号化技術＠セキュリティ
description: ペイロードの暗号化技術＠セキュリティの知見を記録しています。
---
...
## 01. `L7`のペイロードを暗号化する目的

### 盗聴 (ペイロードの盗み取り) を防ぐため

『共通鍵暗号方式』や『公開鍵暗号方式』によって実現される。

暗号アルゴリズムに基づく暗号方式を使用してデータを暗号化することによって、ペイロードの盗聴を防ぐ。
...
相手に送ったデータと相手が受け取ったデータが同じか否かを確認することによって、ペイロードの改竄を防ぐ。
...
デジタル署名に使用した秘密鍵に対応する公開鍵は、成りすました人物による偽の公開鍵の可能性がある。
