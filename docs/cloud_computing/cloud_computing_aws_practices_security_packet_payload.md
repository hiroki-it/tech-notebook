...
| Amazon VPCエンドポイント | Amazon VPCエンドポイント当たり、IPアドレス `1` 個  |
...
| --------------- | -------------- | ---------------------------------- | ---------------- | ------------------- | ----- | --------------------------------------------------------------------------------------------------- |
| `0`             | `matches (OR)` | `Originates from an IP address in` | 社内IPセット     | Source IP address   | -     | 社内の送信元IPアドレスの場合、すべてのパスにリクエストを送信することを許可する。                    |
| `1`             | `matches`      | `Originates from an IP address in` | 協力会社IPセット | Source IP address   | Allow | 0番目あるいは、協力会社の送信元IPアドレスの場合、すべてのパスにリクエストを送信することを許可する。 |

| Default Action | 説明                                                                                   |
| -------------- | -------------------------------------------------------------------------------------- |
| Block          | 指定した送信元IPアドレス以外の場合、すべてのパスにリクエストを送信することを拒否する。 |
