...
リクエスト−レスポンスパターンのアプリケーション、データ、ランタイム、ミドルウェア、コンテナ、OS、仮想サーバーを用意する。
...
リクエスト−レスポンスパターンのアプリケーション、データ、ランタイム、ミドルウェア、コンテナ、OSを用意する。
...
リクエスト−レスポンスパターンのアプリケーション、データ、ランタイム、ミドルウェア、コンテナを用意する。
...
リクエスト−レスポンスパターンのアプリケーション、データを用意する。
