...
| <nobr>`<ファミリー><世代><追加機能>.<サイズ>`</nobr><br>(例: `c5d.xlarge`) | 機能名                                                        |
| -------------------------------------------------------------------------- | ------------------------------------------------------------- |
| インスタンスファミリー                                                     | `t`,`a`、など                                                 |
| インスタンス世代                                                           | `2`、`3`、`4`、など                                           |
| 追加機能                                                                   | `a`、`d`、`g`、など                                           |
| インスタンスサイズ                                                         | `nano`、`small`、`medium`、`large`、`xlarge`、`2xlarge`、など |
...
| アプリケーションのドメイン                     | 相性の良いファミリー | 世代                                                                             | インスタンスサイズ                                                                                                    |
| ---------------------------------------------- | -------------------- | -------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| 業務系アプリケーション                         | `A`系                | 世代数は大きいほど高性能で値段も安い。そのため、その時点で一番新しい世代を選ぶ。 | サイズが一つ大きくなると、ハードウェアリソーススペックと料金が`2`倍になる。アプリケーションが必要とするサイズを選ぶ。 |
| 業務系アプリケーション                         | `T`系                | 同上                                                                             | 同上                                                                                                                  |
| 小/中規模のDB、キャッシュサーバー              | `M`系                | 同上                                                                             | 同上                                                                                                                  |
| HPC、バッチ処理、動画エンコーディング処理      | `C`系                | 同上                                                                             | 同上                                                                                                                  |
| ビッグデータ処理、分散型ファイルシステム       | `H`系                | 同上                                                                             | 同上                                                                                                                  |
| NoSQL DB、DWH、分散型ファイルシステム          | `I`系                | 同上                                                                             | 同上                                                                                                                  |
| ビッグデータ処理、ハイパフォーマンスDB         | `R`系                | 同上                                                                             | 同上                                                                                                                  |
| インメモリDB、ハイパフォーマンスDB             | `X`系                | 同上                                                                             | 同上                                                                                                                  |
| インメモリDB、ハイパフォーマンスDB             | ハイメモリ           | 同上                                                                             | 同上                                                                                                                  |
| 電子設計、RDB                                  | `Z`系                | 同上                                                                             | 同上                                                                                                                  |
| 3D処理、レンダリング、動画処理                 | `G`系                | 同上                                                                             | 同上                                                                                                                  |
| 機械学習、深層学習、HPC                        | `P`系                | 同上                                                                             | 同上                                                                                                                  |
| ゲノム分析、リスク計算、リアルタイムビデオ処理 | `F`系                | 同上                                                                             | 同上                                                                                                                  |
