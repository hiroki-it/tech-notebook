...
| インスタンス世代                                                           | インスタンスの新しさを表す。                                 | `2`、`3`、`4`、など                                           |
| 追加機能                                                                   | 標準ではインスタンスタイプに備わっていない機能を表す。       | `a`、`d`、`g`、など                                           |
...
| アプリケーションのドメイン例                   | ドメインの特長       | ファミリー | 世代                                                                             | インスタンスサイズ                                                                                                                                        |
| ---------------------------------------------- | -------------------- | ---------- | -------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 業務系アプリケーション                         | 汎用                 | `A`系      | 世代数は大きいほど高性能で値段も安い。そのため、その時点で一番新しい世代を選ぶ。 | サイズが一つ大きくなると、ハードウェアリソーススペックと料金が`2`倍になる。ネットワーク帯域はあまり変わらない。アプリケーションが必要とするサイズを選ぶ。 |
| 業務系アプリケーション                         | 汎用                 | `T`系      | 同上                                                                             | 同上                                                                                                                                                      |
| 小/中規模のDB、キャッシュサーバー              | 汎用                 | `M`系      | 同上                                                                             | 同上                                                                                                                                                      |
| HPC、バッチ処理、動画エンコーディング処理      | CPU大量消費系        | `C`系      | 同上                                                                             | 同上                                                                                                                                                      |
| ビッグデータ処理、分散型ファイルシステム       | ストレージ大量消費系 | `H`系      | 同上                                                                             | 同上                                                                                                                                                      |
| NoSQL DB、DWH、分散型ファイルシステム          | ストレージ大量消費系 | `I`系      | 同上                                                                             | 同上                                                                                                                                                      |
| ビッグデータ処理、ハイパフォーマンスDB         | メモリ大量消費系     | `R`系      | 同上                                                                             | 同上                                                                                                                                                      |
| インメモリDB、ハイパフォーマンスDB             | メモリ大量消費系     | `X`系      | 同上                                                                             | 同上                                                                                                                                                      |
| インメモリDB、ハイパフォーマンスDB             | メモリ大量消費系     | ハイメモリ | 同上                                                                             | 同上                                                                                                                                                      |
| 電子設計、RDB                                  | メモリ大量消費系     | `Z`系      | 同上                                                                             | 同上                                                                                                                                                      |
| 3D処理、レンダリング、動画処理                 | GPU大量消費系        | `G`系      | 同上                                                                             | 同上                                                                                                                                                      |
| 機械学習、深層学習、HPC                        | GPU大量消費系        | `P`系      | 同上                                                                             | 同上                                                                                                                                                      |
| ゲノム分析、リスク計算、リアルタイムビデオ処理 | FPGA大量消費系       | `F`系      | 同上                                                                             | 同上                                                                                                                                                      |
