...
> ↪️ 参考：https://docs.docker.jp/compose/compose-file.html
...
> ↪️ 参考：https://github.com/docker-library/mysql/blob/master/5.7/docker-entrypoint.sh#L308-L322

ルートユーザー名は定義できず、『```root```』となる。



> ↪️ 参考：https://github.com/docker-library/mysql/blob/master/5.7/docker-entrypoint.sh#L156
...
> ↪️ 参考：https://docs.docker.com/compose/compose-file/compose-file-v3/#expose
...
> ↪️ 参考：https://docs.fluentd.org/container-deployment/docker-compose#step-0-create-docker-compose.yml
...
> ↪️ 参考：https://qiita.com/ysd_marrrr/items/e8a50c43cff87951385c
...
> ↪️ 参考：https://t-cr.jp/memo/c5179ef2b476237a
...
> ↪️ 参考：https://github.com/docker-library/mysql/blob/master/8.0/Dockerfile.debian#L92-L93
