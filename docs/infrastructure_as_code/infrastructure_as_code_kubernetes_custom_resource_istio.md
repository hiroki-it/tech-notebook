...
|---------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|
| サービスディスカバリー         | KubernetesのServiceとkube-proxyによるIPアドレスとポート番号の検出に加えて、CoreDNSによる名前解決を使用する。                                                                                                                                  | Istiodコントロールプレーンと```istio-proxy```コンテナは、サービスディスカバリーを実施する。サービスディスカバリーに必要な要素を一括でセットアップできる。       |
