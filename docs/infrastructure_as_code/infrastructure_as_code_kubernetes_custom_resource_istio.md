...
| 能力 (執筆時点2023/03/11)               | Istio | Linkerd | Consul | AWS App Mesh |
| --------------------------------------- | :---: | :-----: | :----: | :----------: |
| 異なるClusterにあるデータプレーンの管理 |  ⭕️  |    ×    |  ⭕️   |      ×       |
| 仮想サーバーにあるデータプレーンの管理  |  ⭕️  |    ×    |  ⭕️   |      ×       |
