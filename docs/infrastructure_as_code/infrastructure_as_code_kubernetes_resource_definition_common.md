...
```bash
# カスタムリソース定義の場合
$ kubectl annotate --overwrite crd <カスタムリソース定義> meta.helm.sh/release-namespace="<新しいNamespace>"
...
$ kubectl annotate --overwrite crd <カスタムリソース定義> meta.helm.sh/release-name-
```
