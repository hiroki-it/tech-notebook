...
| エフェクト       | 説明                                                                                                                                                                                                                                  |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| NoExecute        | Tolerationが付与されたPodしかスケジューリングさせられない。付与したPodがすでに稼働している場合、そのPodも再スケジューリングさせる。                                                                                                   |
| NoSchedule       | Tolerationが付与されたPodしかスケジューリングさせられない。付与したPodがすでに稼働している場合、そのPodは再スケジューリングさせない。                                                                                                 |
| PreferNoSchedule | Tolerationが付与されたPodをスケジューリングさせるが、いずれのPodにもこれが付与されていなければ、付与されていないPodもスケジューリングさせる。付与したPodがすでにスケジューリングされている場合、そのPodは再スケジューリングさせない。 |
