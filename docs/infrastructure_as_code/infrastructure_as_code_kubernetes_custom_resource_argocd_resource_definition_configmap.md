...
- `app`ロールに、`app`プロジェクト配下の全てにアクセスできる認可スコープ
- `infra`ロールに、`infra`プロジェクト配下の全てにアクセスできる認可スコープ
...
- `admin`ロールに、全てにアクセスできる認可スコープ
- `app`ロールに、プロジェクト配下の全てにアクセスできる認可スコープ
- `infra`ロールに、プロジェクト配下の全てにアクセスできる認可スコープ
