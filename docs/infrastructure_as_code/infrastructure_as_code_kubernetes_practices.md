...
ファイル名は、Kubernetesリソース名 (例：`deployment.yaml` ファイル) と同じにする。
...
|                                      | 全て自前                                                                                                                                                                                                            | オンプレ                                                                                                                                                                                                                                                                                                                                                                          | クラウド                                                                                                                                                                                                                                                                                        |
| ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Kuberbetesオーケストレーションツール | 全て自前なため、自由にカスタマイズできる。                                                                                                                                                                          | Kubeadm、Rancher、Kops、Kubespray、ベアメタル (例；EKS Anywhere、Anthos on Baremetal)など                                                                                                                                                                                                                                                                                         | Amazon EKS、Google Cloud GKEなど                                                                                                                                                                                                                                                                |
...
一方で、Namespaceを実行環境の粒度とすると、上記のデメリットは少ない。しかし、Namespaceのプレフィクスに実行環境名を付与することになり、名前が長くなってしまう。
...
削除されるPodと作成されるPodのIPアドレスを変える (IPアドレスの再利用を防ぐ) ため、Podの最大数の `2` 倍のIPアドレスを持つCIDRブロックを設定するとよい。
...
Amazon EKSでの目安であるが、サブネットごとに `/19` や `/20` なるように設計するのが、個人的にはおすすめ。
...
DeploymentがまさしくPodを作成できない場合、それだけでHelloWorldのアプリケーションを起動できるイメージがある。
