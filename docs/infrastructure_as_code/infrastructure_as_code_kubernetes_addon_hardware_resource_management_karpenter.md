...
Karpenterは、起動テンプレートを作成したうえでAWS EC2フリートAPIをコールし、AWS EC2 Nodeをスケールアウト/スケールアップする。
...
KarpenterのKarpenter Controllerは、起動テンプレートを作成したうえで、AWS EC2フリートAPIからAWS EC2 Nodeを作成する。
