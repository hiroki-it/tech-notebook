...
ルートモジュール/チャイルドモジュールにて、クラウドプロバイダーの API に対してリクエストを送信し、クラウドインフラを作成する。
...
クラウドプロバイダーの API に対してリクエストを送信し、クラウドインフラに関するデータを取得する。
...
通常時、Terraform の処理順序として、`resource` ブロックの削除後に作成が行われる。
