...
| エンドポイント例 | ・SpringBoot製のJavaアプリなら`/actuator/startup`を使用する。<br>・Nginxなら`200`ステータスを返却するだけの`/healthcheck`を定義する。                                                                                | ➡️  | ・SpringBoot製のJavaアプリなら`/actuator/health/liveness`を使用する。<br>Nginxなら`200`ステータスを返却するだけの`/healthcheck`を定義する。               | ・SpringBoot製のJavaアプリなら`/actuator/health/readiness`を使用する。<br>Nginxなら`/nginx-ready`を使用する。                                                                                                                                                                                                                                                                                                                                |
