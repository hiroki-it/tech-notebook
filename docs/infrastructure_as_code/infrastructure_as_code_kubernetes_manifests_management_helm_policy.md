...
非カスタムリソース定義のみからなるチャートのアップグレードは以下の手順で行う。
...
: kube-apiserverにカスタムリソース定義のマニフェストを送信し、新バージョンのカスタムリソース定義を更新する。
...
> ↪️ 参考：https://github.com/norwoodj/helm-docs
...
> ↪️ 参考：https://hiroki-it.github.io/tech-notebook/infrastructure_as_code/infrastructure_as_code_kubernetes_policy.html
...
> ↪️ 参考：https://hiroki-it.github.io/tech-notebook/infrastructure_as_code/infrastructure_as_code_kubernetes_custom_resource_argocd_policy.html
