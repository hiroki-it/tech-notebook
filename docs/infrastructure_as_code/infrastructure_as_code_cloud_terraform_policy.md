...
# 種類がある時
# 例：ecs_task_cpu = 1024
<用いるクラウドプロバイダーのリソースの名前>_<種類名>_<オプション名> = ****
```
...
一部のクラウドプロバイダーのリソースでは，`description`オプションで説明文を設定できる．基本的には英語で説明する．また，文章ではなく，『関係代名詞/形容詞/副詞/前置詞＋単語』を用いて，『〇〇 な △△』『〇〇 の △△』といった説明になるようにする．
