...
【１】CloudWatchアラームからPagerDutyのServiceに、インシデントを通知する。

【２】PagerDutyのServiceから、インシデントがメールや電話に転送される。執筆時点（2022/12/26）では、電話での通知は英語である。

【３】インシデントの通知を受けたオンコール担当者は、PagerDutyのServiceを確認する。

【４】解決フェーズがOpenになっているインシデントを確認し、問題を解決する。

【５】問題を解決できれば、Resolved状態に移行する。
