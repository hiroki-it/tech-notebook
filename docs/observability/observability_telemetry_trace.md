...
| ID         | 説明                                                                                             |
| ---------- | ------------------------------------------------------------------------------------------------ |
| トレースID | リクエストIDである。すべてのマイクロサービスで同じになる。                                         |
| スパンID   | 各マイクロサービス固有の処理IDである。 すべてのマイクロサービスで異なっている。                    |
...
| ----------- | ------------------ |
| trace-id    | 16進数 (`32` 文字) |
| parent-id   | 16進数 (`16` 文字) |
| trace-flags | 16進数 (`2` 文字)  |
...
| 項目           | 値                                     |
| -------------- | -------------------------------------- |
| trace-id       | 16進数 (`16` 文字または `32` 文字)     |
| span-id        | 16進数 (`16` 文字)                     |
| parent-span-id | 16進数 (`16` 文字)                     |
