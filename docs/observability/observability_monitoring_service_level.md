...
ビジネスに関連する目標値 (例：KPI、SLA) に基づいて、SLOを決める。

SLOを決めることは、性能テストの性能目標値を決めることに似ている。
...
| 指標                           | 完璧の状態                                          | 目標値                                                        |
| ------------------------------ | --------------------------------------------------- | ------------------------------------------------------------- |
| サーバー稼働率                 | サーバーが`24`時間稼働する。                        | `0.01`% (0.24時間) 以内の時間にダウンタイムを抑えること。     |
| DB稼働率                       | DBが`24`時間稼働する。                              | `0.01`% (0.24時間) 以内の時間にダウンタイムを抑えること。     |
