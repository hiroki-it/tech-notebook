...
| [Blackbox Exporter](https://github.com/prometheus/blackbox_exporter)                                                     | 指定したプロトコルで外形監視を実施する。外形監視のため、スクレイピングは一度Cluster外に出る。スクレイピングの成否以外にも、各種メトリクス (レスポンスタイム、HTTPステータスなど) を収集できる。<br>・https://handon.hatenablog.jp/entry/2019/01/29/005935 <br>・https://medium.com/@lambdaEranga/monitor-kubernets-services-endpoints-with-prometheus-blackbox-exporter-a64e062c05d5 | `9115`             | 同上                   |              |
