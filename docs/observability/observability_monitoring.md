...
| 要件          | 説明                                                                                                                                                                                            |
|-------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ストレージ容量     | ログファイルのメトリクスファイルのストレージのサイズを決める。メトリクスファイルの場合、データサイズを抑える工夫（データポイント数の抑制、ダウンサンプリング）があると良い。 |
...
ビジネス指標を対象として、監視を実施する。ビジネス指標の監視に特化した監視ツールを、特に『BIツール（例：Redash、Metabase）』ともいう。
