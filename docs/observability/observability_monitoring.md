...
監視対象からデータ（メトリクスのデータポイント、アプリケーションログ、ブラウザのコンソールログ、ユーザートラフィック、ユーザーエンゲージメント、検索クローラーのサイト評価、など）を収集する。
...
特にパフォーマンスに関わるメトリクスのデータポイントを収集し、監視する。
...
ビジネス指標の監視に特化した監視ツールを、特に『BIツール（例：Redash、Metabase）』ともいう。
