...
| -------------------- | ------------------ | -------------------------- | ----------------------------------------------------------------- |
| `/api/v1/foo`        | 平常時             | `10` tps                   | `10` tps の負荷時に、`99` パーセンタイルが `1` 秒以内に完了する   |
| `/api/v1/bar`        | 平常時             | `20` tps                   | `20` tps の負荷時時に、`99` パーセンタイルが `1` 秒以内に完了する |
| `/api/v1/baz`        | 平常時             | `15` tps                   | `15` tps の負荷時時に、`99` パーセンタイルが `1` 秒以内に完了する |
