...
| -------------- | -------------------------- | ------------------------------------------------------------- |
| `/api/v1/foo`  | `10` tps                   | `10` tpsの負荷時に、`99`パーセンタイルが`1`秒以内に完了する   |
| `/api/v1/bar`  | `20` tps                   | `20` tpsの負荷時時に、`99`パーセンタイルが`1`秒以内に完了する |
| `/api/v1/baz`  | `15` tps                   | `15` tpsの負荷時時に、`99`パーセンタイルが`1`秒以内に完了する |
