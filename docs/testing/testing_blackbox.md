...
|         | UT                             | -                    | ビルトインのダッシュボード（```***-mixin```タグがついている）を正しく読み込めるか。                                                     |                                                                                                                 |
|         | IT                             | Grafana + Prometheus | ビルトインのダッシュボードでPromQLを入力し、Prometheusのメトリクスを確認できる。                                 |                                                                                                                 |
|         | IT                             | Grafana + Prometheus | ビルトインのダッシュボードでPrometheusのメトリクスのリアルタイムデータを確認できる。                               |                                                                                                                 |
|         | IT                             | Grafana + Prometheus | ビルトインのダッシュボード上で、datasource、namespace、type、resolusion、の条件を変更し、リアルタイムデータを確認できる。 |                                                                                                                 |
