...
| テスト種別<br>(UT：単体テスト、IT：結合テスト) | 組み合わせ (ITの場合のみ) | テストケース                                                 |
| ---------------------------------------------- | ------------------------- | ------------------------------------------------------------ |
...
各種Exporterのテストケース例を示す。

| Exporter名         | テスト種別<br>(UT：単体テスト、IT：結合テスト) | 組み合わせ (ITの場合のみ)                            | テストケース                                                 |
| ------------------ | ---------------------------------------------- | ---------------------------------------------------- | ------------------------------------------------------------ |
...
| コンポーネント | テスト種別<br>(UT：単体テスト、IT：結合テスト) | 組み合わせ (ITの場合のみ) | テストケース                            |
| -------------- | ---------------------------------------------- | ------------------------- | --------------------------------------- |
