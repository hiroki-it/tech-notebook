...
|------------| -------------------------------------------- | ------------------------------ |-------------------------------------------------------------------------------------------------------|--------------------------------------------------|
| Prometheus | UT                                           | - | Podが正常である。                                                                                            | 『PodがRunningフェーズかつReadyコンディションであること』をPodの正常とみなす。例えば、```kubectl get```コマンドを実行し、正常か否かを確認する。 |
...
| コンポーネント     | テスト種別（UT：単体テスト、IT：結合テスト） | 組み合わせ（ITの場合のみ）     | テストケース                                                 | 補足                                               |
| ------------------ | -------------------------------------------- | ------------------------------ | ------------------------------------------------------------ |--------------------------------------------------|
| Alertmanager       | UT                                           | - | Podが正常である。                                            | 『PodがRunningフェーズかつReadyコンディションであること』をPodの正常とみなす。例えば、```kubectl get```コマンドを実行し、正常か否かを確認する。 |
...
| コンポーネント     | テスト種別（UT：単体テスト、IT：結合テスト） | 組み合わせ（ITの場合のみ）     | テストケース                                                 | 補足                                               |
| ------------------ | -------------------------------------------- | ------------------------------ | ------------------------------------------------------------ |--------------------------------------------------|
| Grafana            | UT                                           | - | Podが正常である。                                            | 『PodがRunningフェーズかつReadyコンディションであること』をPodの正常とみなす。例えば、```kubectl get```コマンドを実行し、正常か否かを確認する。 |
...
| コンポーネント     | テスト種別（UT：単体テスト、IT：結合テスト） | 組み合わせ（ITの場合のみ） | テストケース                                                 | 補足                                                         |
| ------------------ | -------------------------------------------- | -------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| PrometheusOperator | UT                                           | -                          | PodMonitorの既存の設定が正常に動作しており、異常を検知するとアラートを発火できる。 | 『PodがRunningフェーズかつReadyコンディションであること』をPodの正常とみなす。例えば、```kubectl get```コマンドを実行し、正常か否かを確認する。 |
...
| コンポーネント     | テスト種別（UT：単体テスト、IT：結合テスト） | 組み合わせ（ITの場合のみ） | テストケース      | 補足                                                         |
| ------------------ | -------------------------------------------- | -------------------------- | ----------------- | ------------------------------------------------------------ |
| kube-state-metrics | UT                                           | -                          | Podが正常である。 | 『PodがRunningフェーズかつReadyコンディションであること』をPodの正常とみなす。例えば、```kubectl get```コマンドを実行し、正常か否かを確認する。 |

node-exporterのテストケース例を示す。

| コンポーネント | テスト種別（UT：単体テスト、IT：結合テスト） | 組み合わせ（ITの場合のみ） | テストケース      | 補足                                                         |
| -------------- | -------------------------------------------- | -------------------------- | ----------------- | ------------------------------------------------------------ |
| node-exporter  | UT                                           | -                          | Podが正常である。 | 『PodがRunningフェーズかつReadyコンディションであること』をPodの正常とみなす。例えば、```kubectl get```コマンドを実行し、正常か否かを確認する。 |

metrics-serverのテストケース例を示す。

| コンポーネント | テスト種別（UT：単体テスト、IT：結合テスト） | 組み合わせ（ITの場合のみ）  | テストケース                                                 | 補足                                                         |
| -------------- | -------------------------------------------- | --------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| metrics-server | UT                                           | -                           | Podが正常である。                                            | 『PodがRunningフェーズかつReadyコンディションであること』をPodの正常とみなす。例えば、```kubectl get```コマンドを実行し、正常か否かを確認する。 |
...
| コンポーネント | テスト種別（UT：単体テスト、IT：結合テスト） | 組み合わせ（ITの場合のみ） | テストケース      | 補足                                                         |
| -------------- | -------------------------------------------- | -------------------------- | ----------------- | ------------------------------------------------------------ |
| process-exporter  | UT                                           | -                          | Podが正常である。 | 『PodがRunningフェーズかつReadyコンディションであること』をPodの正常とみなす。 |
...
| コンポーネント     | テスト種別（UT：単体テスト、IT：結合テスト） | 組み合わせ（ITの場合のみ）     | テストケース                                                 | 補足                                               |
| ------------------ | -------------------------------------------- | ------------------------------ | ------------------------------------------------------------ |--------------------------------------------------|
| Istio             | UT | - | コントロールプレーンのPod（```istio-deployment```というDeployment配下のPod）が正常である。 |『PodがRunningフェーズかつReadyコンディションであること』をPodの正常とみなす。例えば、```kubectl get```コマンドを実行し、正常か否かを確認する。|
...
| コンポーネント     | テスト種別（UT：単体テスト、IT：結合テスト） | 組み合わせ（ITの場合のみ）      | テストケース                                                 | 補足                                                         |
| ------------------ | -------------------------------------------- | ------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| cluster-autoscaler | UT                                           | -                               | Podが正常である。                                            | 『PodがRunningフェーズかつReadyコンディションであること』をPodの正常とみなす。例えば、```kubectl get```コマンドを実行し、正常か否かを確認する。 |
...
| コンポーネント | テスト種別（UT：単体テスト、IT：結合テスト） | 組み合わせ（ITの場合のみ）            | テストケース                                                 | 補足                                                         |
| -------------- | -------------------------------------------- | ------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Fluentd        | UT                                           | -                                     | Podが正常である。                                            | 『PodがRunningフェーズかつReadyコンディションであること』をPodの正常とみなす。例えば、```kubectl get```コマンドを実行し、正常か否かを確認する。 |
