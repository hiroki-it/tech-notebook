...
定義されていないデータや、アクセス権のないデータを取得しようとした時に、代わりに呼び出される。
...
定義されていないメソッドや、アクセス権のないメソッドを取得しようとした時に、代わりにコールされる。
...
定義されていないデータや、アクセス権のないデータに値を設定しようとした時に、代わりにコールされる。
...
以下の通り、`self`メソッドは定義されたクラスをインスタンス化する。
...
特定のイベント名が渡された時に、それに対応づけられた関数をコールする。
