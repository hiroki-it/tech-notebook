---
title: 【IT技術の知見】バリデーションロジック＠Go
description: バリデーションロジック＠Goの知見を記録しています。
---
...
| バリデーションパターン | `if (var)` | `if len(var) == 0` | `if var != nil` | `in var == 0`、`if reflect.ValueOf(var).IsZero()` |
| :--------------------: | :--------: | :----------------: | :-------------: | :-----------------------------------------------: |
|       **`nil`**        |            |                    |                 |                                                   |
|        **`0`**         |            |                    |                 |                        ✅                         |
|        **`1`**         |            |                    |                 |                                                   |
