...
| ---- | ------------------- | ---------------- | ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1    | ブラウザ上          | -                | -                                                     | 最初、ブラウザからRemixにリクエストを送信する。ほかに、アクション中のLinkコンポーネントが、URLクエリストリングのページ値（`?page=n`）が書き換える。                                                                               |
...
| 7    | remixコンポーネント | `app/components` | UIロジック、CSSスタイリングロジック、状態管理ロジック | ２番に同じ                                                                                                                                                                                                                        |
