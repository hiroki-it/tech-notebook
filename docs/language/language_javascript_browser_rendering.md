---
title: 【IT技術の知見】レンダリング
description: レンダリングの知見を記録しています。
---
...
このうち、テキストファイルをタグとデータによって構造的に表現し、ハードウェアが読み込める状態にする言語のこと。
...
> - https://www.researchgate.net/publication/228930844_Real-time_Generalization_of_Geodata_in_the_WEB
...
> - https://rfs.jp/sb/javascript/01js/z01.html
...
JavaScript エンジンは、コードを、字句解析、構造解析、意味解釈、命令の実行をコード１行ずつに対し、繰り返し実行する。
...
`false` を設定することで、イベントバブリングを行わせない。
