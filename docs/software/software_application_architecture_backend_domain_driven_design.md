...
1. 受注管理する人は、商品オブジェクトが持つ注文内容/値段に関するデータに関心がある。
2. 在庫管理する人は、商品オブジェクトが持つ在庫数に関するデータに関心がある。
3. 発送管理する人は、商品オブジェクトが持つ発送状況に関するデータに関心がある。
4. 請求管理する人は、商品オブジェクトが持つ請求状況に関するデータに関心がある。
5. 仕入れ管理する人は、商品オブジェクトが持つ仕入れ状況に関するデータに関心がある。
