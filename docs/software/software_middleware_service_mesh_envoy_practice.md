...
### 1. 送信元 Envoy から宛先 Envoy へのリクエストヘッダー
...
### 2. 宛先 Envoy から送信元 Envoy へのレスポンスヘッダー

#### ▼ 宛先 Envoy から送信元 Envoy へのレスポンスヘッダーとは
...
### 3. 送信元 Envoy からアプリへのレスポンスヘッダー

#### ▼ 送信元 Envoy からアプリへのレスポンスヘッダーとは
