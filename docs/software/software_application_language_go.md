...
| 高速なコンパイル               | 他の静的型付け言語のJavaのコンパイルでは，コードを一度中間言語に変換し，その後機械語に翻訳する．しかしGoのコンパイルでは，プログラムを直接機械語に翻訳するため，より高速である． |
...
Goには，標準でイミュータブルの機能がなく，これを無理に実現しようとすると逆に保守性が低くなることがある．そのため，イミュータブルにするかどうかは慎重に判断する．
