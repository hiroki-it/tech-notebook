...
| `reset`                  | 宛先アプリコンテナから`istio-proxy`コンテナに返信できたが、通信の切断／リセット／タイムアウト (特に) が起こった。 |
...
| 設定                   | 理由                                                                                                                              |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| `reset-before-request` | 宛先アプリコンテナから`istio-proxy`コンテナに返信できず、通信のリセット／タイムアウト (特にコネクションタイムアウト) が起こった。 |
