...
バックエンドアプリケーションが存在する場合、SSRとは異なり、ブラウザ上の静的ファイルはCSRアプリケーションを経由しバックエンドアプリケーションと通信する。
...
バックエンドアプリケーションが存在する場合、CSRとは異なり、ブラウザ上の静的ファイルはSSRアプリケーションを経由せずにバックエンドアプリケーションと通信する。
