...
| ------------------- | ---------------------------------------------------------------------- | :------------------------------: | :-----: | :----: | :-------------: |
| 相互TLS認証         | 相互TLS認証ツール<br>(例：Spiffe)                                      | `⭕️`<br>(Spiffeへ置き換えできる) |  `⭕️`   |  `⭕️`  |      `⭕️`       |
| SSL証明書の自動更新 | ・手動でSSL証明書を更新<br>・SSL証明書管理ツール<br>(例：Cert Manager) |               `⭕️`               |    ×    |  `⭕️`  |      `⭕️`       |
...
| マイクロサービスのゴールデンシグナルをメトリクス監視バックエンド<br>(例：Prometheus) へ送信する | クライアントパッケージ<br>(例：otelクライアントパッケージなど) | `⭕️`  |  `⭕️`   |  `⭕️`  |      `⭕️`       |
...
| ---------------------- | :----------------------------: | :-----: | :----: | :-------------: | ------------------------ |
| サイドカーパターン     |              `⭕️`              |  `⭕️`   |  `⭕️`  |      `⭕️`       | ×                        |
| サイドカーレスパターン | `⭕️`<br>(アンビエントメッシュ) |    ×    |   ×    |        ×        | `⭕️`<br>(カーネルモデル) |
