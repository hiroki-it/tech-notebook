...
エンティティ層と同じマイクロサービス内で実行する。

最も一般的な分割パターンである。

#### ▼ エンティティ層とは異なるマイクロサービス + 占有リポジトリ単位 (ルートエンティティ単位)

エンティティ層とは異なるマイクロサービス内で実行する。
...
#### ▼ エンティティ層とは異なるマイクロサービス + 共有リポジトリ単位 (ルートエンティティ単位)
