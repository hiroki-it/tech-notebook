...
### セッション ID を Cookie ヘッダーで運搬するパターン
...
## 01-05. JWT と API ゲートウェイの組み合わせパターン (ゲートウェイ集中パターン)

### JWT と API ゲートウェイの組み合わせパターンとは
...
### JWT と API ゲートウェイの組み合わせパターンの仕組み
