...
初代ドラゴンクエストにおける経験値の上限は『`65535`』だった。
...
### 排他的論理和回路 (EOR 回路/XOR 回路) 、EOR 演算、ベン図
