...
| HTTP/1.1のステータスコード                                  | アプリコンテナに通信が届いている |                                リトライしてもよい                                | リトライ条件                                                                                                                                                                                          |
| ----------------------------------------------------------- | :------------------------------: | :------------------------------------------------------------------------------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| HTTP/2のステータスコード | アプリコンテナに通信が届いている |                          リトライしてもよい                          | リトライ条件                                                                                                     |
| ------------------------ | :------------------------------: | :------------------------------------------------------------------: | ---------------------------------------------------------------------------------------------------------------- |
...
| `refused-stream`         |                ⭕️                |                                  ✅                                  | 同時接続上限数を超過するストリームをアプリコンテナが作成しようとした。                                           |
...
| HTTP/1.1のステータスコード | アプリコンテナに通信が届いている | リトライしてもよい | 理由                                                                                        |
| -------------------------- | :------------------------------: | :----------------: | ------------------------------------------------------------------------------------------- |
| `reset-before-request`     |                ×                 |         ✅         | `istio-proxy`コンテナへのインバウンド通信で、アプリコンテナにリクエストを転送できなかった。 |
