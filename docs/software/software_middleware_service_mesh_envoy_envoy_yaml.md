...
インバウンド通信/アウトバウンド通信をHTTPSプロトコルで送受信する場合に、証明書を設定する。
...
> ↪️ 参考：https://www.envoyproxy.io/docs/envoy/latest/configuration/overview/xds_api#aggregated-discovery-service
