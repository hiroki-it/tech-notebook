...
| :--------: | -------------- | -------------------------- | :----- | :------- | :----- | ------------------------------------------------------- |
|   `500`    | 記入中...      | `r-x`                      | `r-x`  | `---`    | `---`  | 所有者以外に全権限なし。所有者は、Read とExecute のみ。 |
|   `600`    | 記入中...      | ``                         | `rw-`  | `---`    | `---`  | 所有者以外に全権限なし。所有者は、Read とWrite のみ。   |
...
| 数字モード | シンボルモード | 所有者 + グループ + その他 | 所有者 | グループ | その他 | 特徴                                           |
| :--------: | -------------- | -------------------------- | :----- | :------- | :----- | ---------------------------------------------- |
|   `555`    | `a=+rx`        | `r-xr-xr-x`                | `r-x`  | `r-x`    | `r-x`  | すべてに Write 権限なし。Read とExecute のみ。 |
|   `666`    | `a=+rw`        | `rw-rw-rw-`                | `rw-`  | `rw-`    | `rw-`  | すべてに Execute 権限なし。Read とWrite のみ。 |
...
| 数字モード | シンボルモード | 所有者 + グループ + その他 | 所有者 | グループ | その他 | 特徴                                                 |
| :--------: | -------------- | -------------------------- | :----- | :------- | :----- | ---------------------------------------------------- |
|   `644`    | 記入中...      | `rw-r--r--`                | `rw-`  | `r--`    | `r--`  | 所有者以外に Write とExecute 権限なしで、Read のみ。 |
|   `755`    | 記入中...      | `rwxr-xr-x`                | `rwx`  | `r-x`    | `r-x`  | 所有者以外に Write 権限なしで、Read とExecute のみ。 |
