...
|                  | マイクロサービスの分割         | ・ドメイン駆動設計に基づく境界<br>・永続データの機密性の差異 (ほかから隔離すべき機密データ) <br>・永続データの所有組織の差異<br>・非同期的な機能 (例：メール／プッシュ通知の機能) |
...
代表的なものには、DDDに基づく境界、永続データの機密性の差異 (ほかから隔離すべき機密データ) 、永続データの所有組織、非同期で呼び出すことが向いている機能 (例：メール／プッシュ通知機能など) があります。
...
flowchart LR
  ...
  マイクロサービス分割方法の基点 ---- 永続データの機密性差異[永続データ<br>機密性の差異<br>(ほかから隔離すべき機密データ)]
  マイクロサービス分割方法の基点 ---- 永続データの所有組織差異[永続データ<br>所有組織の差異]
  マイクロサービス分割方法の基点 ---- 非同期的な機能[非同期的な機能]
```
...
DDDの考え方をマイクロサービスアーキテクチャに取り入れることにより、適切な凝集度と結合度を持つマイクロサービスに分割できます。
