...
| マイクロサービス | マイクロサービス間の通信       | ・リクエスト／レスポンス方式<br>・パブリッシュ／サブスクライブ方式<br>・ストリーミング方式<br>・共有データ方式                                                                                                                                                                                                                                            |
...
代表的なものには、リクエスト／レスポンス方式、パブリッシュ／サブスクライブ方式、ストリーミング、共有データ交換方式があります。
...
| パターン名                       | リクエスト／レスポンス方式                                                                                                                           | パブリッシュ／サブスクライブ方式                                                                                                                                                                                                                                              | ストリーミング方式 | 共有データ交換方式                                                                                                                                                                                                                                                               |
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
図12で、AWS EKS上でのリクエスト／レスポンス方式の設計例を示します。
...
図13. AWS EKS上でのリクエスト／レスポンス方式の設計例
