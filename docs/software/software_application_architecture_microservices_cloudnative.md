...
|                  | マイクロサービスの分割         | ・ドメイン駆動設計に基づく境界<br>・認証／認可<br>・永続データの機密度 (例：換金性の高い情報) <br>・永続データの所有組織の差異<br>・非同期的な機能 (例：メール／プッシュ通知の機能) |
...
代表的なものには、ドメイン駆動設計に基づく境界、認証／認可、永続データの機密度 (例：換金性の高い情報) 、永続データの所有組織、非同期で呼び出すことが向いている機能 (例：メール／プッシュ通知機能など) があります。
