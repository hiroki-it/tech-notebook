...
本番環境に機能をデプロイするためのブランチ．productionブランチとしてもよい．CI/CDツールを用いて，バージョンタグの付与によってデプロイが発火するようにする．
...
ステージング環境に機能をデプロイするためのブランチ．stagingブランチとしてもよい．CI/CDツールを用いて，コミット（マージコミットを含む）によってデプロイが発火するようにする．
